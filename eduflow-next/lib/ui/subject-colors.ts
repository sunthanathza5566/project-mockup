/** สีประจำกลุ่มสาระ — ใช้ร่วมกันทั้งฝั่งครูและนักเรียน (ตารางสอน/ตารางเรียน/ห้องเรียน) */
export const SUBJECT_COLORS: Record<string, { bg: string; border: string; text: string; dot: string }> = {
  ...
  work:     { bg:'rgba(158,123,86,0.13)',  border:'rgba(158,123,86,0.35)',  text:'#5A3A20', dot:'#9E7B56' },
...
export function subjectColor(key: string) {
  return SUBJECT_COLORS[key] || SUBJECT_COLORS.guidance;
}
