      ...
      <div className="dash-content">
        ...
        <div className="dash-section">
          ...
          <div className="dash-actions-row">
            <button className="dash-action-btn" onClick={() => showToast('กำลังสร้าง QR Code...')}>🔲 สร้าง QR Code เช็คชื่อ</button>
            <button className="dash-action-btn" onClick={() => showToast('กำลังสร้างรายงาน...')}>📊 ดูรายงาน</button>
            <button className="dash-action-btn" onClick={() => showToast('กำลังมอบหมายการบ้าน...')}>📚 มอบหมายการบ้าน</button>
            <button className="dash-action-btn" onClick={() => showToast('กำลังอัปโหลดเอกสาร...')}>📁 อัปโหลดสื่อการสอน</button>
          </div>
        </div>
        ...
        <div style={{ background: 'var(--cream)', border: '1px dashed var(--border)', borderRadius: 12, padding: '1.25rem', fontSize: '0.82rem', color: 'var(--text-muted)', lineHeight: 1.7 }}>
          ...
          · เช็คชื่อนักเรียนแต่ละคาบแบบ real-time<br />
